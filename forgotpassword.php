...
{
$em=$_POST['txtemail'];
$data=mysql_query("select * from employee where email='$em'");
date_default_timezone_set("America/New_York");
$encryptStr = $em.date("Y/m/d");
$encstr=crypt($encryptStr);
//echo $encstr;
mysql_query("update employee set astr ='$encstr' where email='$em'");
$str="Click on link to change password <a href='".$site_url."newpassword.php?mail=$encstr'>CLICK</a>";
if(mysql_num_rows($data)==1)
{
   if(mail($em,"Forgot Pw","$str","From:admin\r\nContent-type:text/html"))
   {
