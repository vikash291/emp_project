	...
	{	
	    if(obj.readyState==4)
	    {
	       ...
	       lft=0;
              ...
              document.getElementById('datediv').innerHTML+="<div class='col-md-3' style='width:25px;text-align:center;height:20px;float:left;margin:2px 2px 2px 2px;padding:3px;font-size:13px;bottom:0;position:absolute;word-wrap:normal;left:"+lt+"px'><b style='width:30px;height=30px'>"+cdate+"/"+cmon+"</b></div>";
                          ...
                          document.getElementById('datediv').innerHTML+="<div  class='col-md-3' style='width:30px;text-align:center;height:25px;float:left;margin-left:10px;padding:3px;font-size:15px;bottom:0;position:absolute;word-wrap:normal;left:"+lt1+"px'><b style='width:30px;height=30px'>"+cdate+"/"+cmon+"</b></div>";
		  ...
		  if(document.getElementById("rmv").checked==false){
                       if( totaldate<25 )
                       {
                             lft=lft+40;
                             lt1=lt1+40;
                        document.getElementById('divchat').innerHTML+="<div class='col-md-3'style='width:30px;background-color:black;height:1px;float:left;margin-left:10px;padding:2px;position:absolute;font-size:10px;border:1px solid #000;bottom:0;left:"+lft+"px'> </div>";
                         ...
                         {     
                             lft=lft+30;
                             lt=lt+30;
                            document.getElementById('divchat').innerHTML+="<div class='col-md-3'style='width:25px;background-color:black;height:1px;float:left;margin-left:05px;color:white;padding:2px;position:absolute;font-size:10px;border:1px solid #000;bottom:0;left:"+lft+"px'> </div>";
