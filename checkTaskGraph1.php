...
<body>
    ...
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
              <li class=""><a href="createTask.php"><span class="glyphicon glyphicon-user">CreateEmployee</span></a></li>
      ...
      <li><a href="myProfile.php"><span class="glyphicon glyphicon-list-alt">Employee-List</span></a></li>
        </ul>
...
<div class="form-group">
<div id='rec' style="color:darkred;font-size:18px;"></div>
</div>
