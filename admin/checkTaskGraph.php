...
window.open('taskGraphPrint.php?name='+name+'&date='+calander+'&date1='+calander1);*/
};
...
document.getElementById('resdt').innerHTML=name+" &emsp;&emsp;"+disdate;
}
...
<input type="button" onclick="fun_print()" value="Page Print" class="btn btn-danger">
<span id="res" style="color:darkred;font-size:18px"></span>
</div>
<!--Current Date:<span id="div1">{{date  | date:'yyyy-MM'}}</div>
<br>-->
</form>
<div class="form-group" id="clearDiv">
